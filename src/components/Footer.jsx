...
export default function Footer() {
  const socials = [
    ...
    { name: "WhatsApp", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/whatsapp.svg", url: "https://whatsapp.com/channel/0029VbB8P8WLCoWwrOnDDcOn" },
  ];
    ...
    <footer className="bg-white dark:bg-slate-900 border-t mt-16 py-10 text-center text-slate-700 dark:text-slate-300">
      <div className="max-w-6xl mx-auto flex flex-col gap-8"> 
        ...
        <div className="border-t pt-6 text-sm text-slate-500 dark:text-slate-400">
          © {new Date().getFullYear()} <strong>ROAN CYBER HACH</strong>
        </div>
